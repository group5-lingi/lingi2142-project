...
ip6tables -A INPUT -p tcp --dport 179 -i rubicon -s fde4::6:deaf -j ACCEPT
ip6tables -A OUTPUT -p tcp --dport 179 -o rubicon -d fde4::6:deaf -j ACCEPT
...
ip6tables -A INPUT -p 89 -i P7-EF-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P7-EF-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P7-EF-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P7-EF-eth1 -j ACCEPT
