...
ip6tables -A INPUT -p 89 -i P16-LG-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P16-LG-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P16-LG-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P16-LG-eth1 -j ACCEPT
