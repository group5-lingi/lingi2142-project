...
ip6tables -A INPUT -p 89 -i P14-WF-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P14-WF-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P14-WF-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P14-WF-eth1 -j ACCEPT
