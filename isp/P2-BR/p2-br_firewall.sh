...
ip6tables -A INPUT -p 89 -i P2-BR-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth1 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth2 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth2 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth3 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth3 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth4 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth4 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth5 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth5 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth6 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth6 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth7 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth7 -j ACCEPT
ip6tables -A INPUT -p 89 -i P2-BR-eth8 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P2-BR-eth8 -j ACCEPT
