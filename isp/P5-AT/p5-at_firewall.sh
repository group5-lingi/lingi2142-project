...
ip6tables -A INPUT -p tcp --dport 179 -i lethe -s fde4:5:3000:1::1 -j ACCEPT
ip6tables -A OUTPUT -p tcp --dport 179 -o lethe -d fde4:5:3000:1::1 -j ACCEPT
...
ip6tables -A INPUT -p 89 -i P5-AT-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P5-AT-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P5-AT-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P5-AT-eth1 -j ACCEPT
