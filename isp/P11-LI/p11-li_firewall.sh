...
ip6tables -A INPUT -p tcp --dport 179 -i kerlaugar -s fde4::7:face -j ACCEPT
ip6tables -A OUTPUT -p tcp --dport 179 -o kerlaugar -d fde4::7:face -j ACCEPT
...
ip6tables -A INPUT -p 89 -i P11-LI-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P11-LI-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P11-LI-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P11-LI-eth1 -j ACCEPT
