...
ip6tables -A INPUT -p 89 -i P12-LI-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P12-LI-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P12-LI-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P12-LI-eth1 -j ACCEPT
