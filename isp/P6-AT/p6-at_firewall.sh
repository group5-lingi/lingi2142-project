...
ip6tables -A INPUT -p 89 -i P6-AT-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P6-AT-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P6-AT-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P6-AT-eth1 -j ACCEPT
