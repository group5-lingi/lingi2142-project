...
ip6tables -A INPUT -p tcp --dport 179 -i celadon -s fde4:4:f001:5::beef -j ACCEPT
ip6tables -A OUTPUT -p tcp --dport 179 -o celadon -d fde4:4:f001:5::beef -j ACCEPT
...
ip6tables -A INPUT -p 89 -i P9-FB-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P9-FB-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P9-FB-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P9-FB-eth1 -j ACCEPT
