...
ip6tables -A INPUT -p 89 -i P15-LG-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P15-LG-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P15-LG-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P15-LG-eth1 -j ACCEPT
