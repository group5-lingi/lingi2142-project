...
ip6tables -A INPUT -p 89 -i P3-BR-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P3-BR-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P3-BR-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P3-BR-eth1 -j ACCEPT
ip6tables -A INPUT -p 89 -i P3-BR-eth2 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P3-BR-eth2 -j ACCEPT
