...
ip6tables -A INPUT -p 89 -i P8-EF-eth0 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P8-EF-eth0 -j ACCEPT
ip6tables -A INPUT -p 89 -i P8-EF-eth1 -j ACCEPT
ip6tables -A OUTPUT -p 89 -o P8-EF-eth1 -j ACCEPT
