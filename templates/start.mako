...
LD_LIBRARY_PATH=/usr/local/lib /usr/lib/frr/zebra -A 127.0.0.1 -f /etc/zebra.conf -z /tmp/${data['name'].lower()}.api -i /tmp/${data['name'].lower()}_zebra.pid --v6-rr-semantics &
